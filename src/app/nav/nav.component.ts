...
export class NavComponent {
  ...
  elements: {
    ...
    {
      name: "Ma toile",
      icon: `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 14 14"><g fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"><path d="M13.5 7A6.5 6.5 0 1 1 7 .5"/><path d="m10.5.5l-5 5l-1 4l4-1l5-5"/></g></svg>`,
      children: [
        {
